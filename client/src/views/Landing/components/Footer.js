  ...
  block = () => [
    {
      ...
      content: (
        <span className='footer-about'>
          <p>
            <b>EventBox</b> is an online ticketing and event management
      ...
      content: (
        <span className='footer-address'>
          <p>
            ...
            <span><i> 45 Nguyen Khac Nhu St., Cô Giang ward
              , District 1, Ho Chi Minh city</i></span>
          </p>
          <p>
            <b>Campus 2</b><br />
            <Icon type='environment' />
            <span><i> 233A Phan Van Tri St., Ward 11
              , Binh Thanh Dist., Ho Chi Minh city</i></span>
          </p>
          <p>
            <b>Campus 3</b><br />
            <Icon type='environment' />
            <span><i> 80/68 Duong Quang Ham St., Ward 5
              , Go Vap Dist., Ho Chi Minh city</i></span>
          </p>
        </span>
      )
    },
    {
      ...
      content: (
        <span className='footer-contact'>
          <p>
            <b><Icon type='phone' theme='filled' /> Hotline:</b>
            <span> Monday - Friday (8:30 AM - 7:30 PM) </span>
          </p>
    ...
    },
    {
      ...
      content: (
        <span className='footer-quickaccess'>
          <p>
            <b>FAQ</b><br />
            <span><i>Frequently Asked Questions</i></span>
          </p>
          <p>
            <b>Subscribe us</b>
            <Input.Search
