...
class EventUpdate extends Component{
  ...
  state = {
    ...
    rawContent: JSON.stringify(convertToRaw(EditorState.createEmpty().getCurrentContent()))
  }
  editor = null
  ...
  componentDidMount = async () => {
    ...
    this.setState({
      ...
      rawContent: result.data.event.description
    })
  }
  ...
  render() {
    ...
    const { loading, buttonLoading, rawContent } = this.state
          ...
          >
            {!loading &&
              <EditorWysiwyg
                ...
                defaultContentState={JSON.parse(rawContent)}
