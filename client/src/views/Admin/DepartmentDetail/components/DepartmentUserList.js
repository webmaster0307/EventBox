...
class HeadDepartmentList extends Component{
  ...
  render() {
    ...
    const users = [
      ...
      {'id':'5c395603bdc12c00255b3615','username':'nammai3','email':'nam1997@gmail.com','__typename':'User'}
    ]
    const loading = true

    return (
      <div>
        <Button type='primary' onClick={this.handleAddMember} >Thêm trưởng khoa</Button>
        <Divider />
        <List
          itemLayout='horizontal'
          dataSource={users}
